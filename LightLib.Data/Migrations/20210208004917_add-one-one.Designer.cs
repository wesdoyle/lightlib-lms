...
namespace LightLib.Data.Migrations
{
    ...
    [Migration("20210208004917_add-one-one")]
    partial class addoneone
    {
            ...
            modelBuilder.Entity("LightLib.Data.Models.Assets.AudioBook", b =>
                {
                    b.HasOne("LightLib.Data.Models.Assets.Asset", "Asset")
                        .WithOne("AudioBook")
                        .HasForeignKey("LightLib.Data.Models.Assets.AudioBook", "AssetId")
            ...
            modelBuilder.Entity("LightLib.Data.Models.Assets.AudioCd", b =>
                {
                    b.HasOne("LightLib.Data.Models.Assets.Asset", "Asset")
                        .WithOne("AudioCd")
                        .HasForeignKey("LightLib.Data.Models.Assets.AudioCd", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LightLib.Data.Models.Assets.Book", b =>
                {
                    b.HasOne("LightLib.Data.Models.Assets.Asset", "Asset")
                        .WithOne("Book")
                        .HasForeignKey("LightLib.Data.Models.Assets.Book", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LightLib.Data.Models.Assets.DVD", b =>
                {
                    b.HasOne("LightLib.Data.Models.Assets.Asset", "Asset")
                        .WithOne("DVD")
                        .HasForeignKey("LightLib.Data.Models.Assets.DVD", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LightLib.Data.Models.Assets.Periodical", b =>
                {
                    b.HasOne("LightLib.Data.Models.Assets.Asset", "Asset")
                        .WithOne("Periodical")
                        .HasForeignKey("LightLib.Data.Models.Assets.Periodical", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
